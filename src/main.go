...
func main() {
	...
	r.GET("/setting/", settingsHandler.GetAllSettings)
	r.GET("/setting/active", settingsHandler.GetAllActiveSettings)
	r.GET("/setting/:id", settingsHandler.GetSetting)
	r.POST("/setting/", settingsHandler.CreateSetting)
	r.PATCH("/setting/:id", settingsHandler.UpdateSetting)
	r.DELETE("/setting/:id", settingsHandler.RemoveSetting)
